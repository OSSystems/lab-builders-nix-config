...
{
  users.users.gabriel = {
    description = "Gabriel Wille";

    isNormalUser = true;
    extraGroups = [ "docker" "wheel" ];

    openssh.authorizedKeys.keys = [
      "ssh-rsa  gabriel@ossystems"
    ];
  ...
  home-manager.users.gabriel = {
    ...
    programs.git = {
      ...
      userEmail = "gabriel.oliveira@ossystems.com.br";
